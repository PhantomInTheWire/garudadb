...
pub use layout::{
    ...
    LOCK_FILE_NAME, SCALAR_INDEX_DIR_NAME, SCALAR_INDEX_FILE_SUFFIX, WRITING_SEGMENT_ID,
    collection_dir, delete_snapshot_path, ensure_database_root, ensure_existing_collection_dir,
    ensure_new_collection_dir, id_map_snapshot_path, manifest_path, manifest_paths,
    remove_path_if_exists, segment_data_path, segment_dir, segment_flat_index_path,
    segment_hnsw_index_path, segment_scalar_index_dir, segment_scalar_index_path, segment_wal_path,
};
pub use snapshots::{
